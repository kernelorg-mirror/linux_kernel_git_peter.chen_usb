...
static const struct of_device_id pwrseq_match_table_list[] = {
	{ .compatible = "usb1a40,0201", .data = &pwrseq_generic_alloc_instance},
	{ .compatible = "usbb95,1780", .data = &pwrseq_generic_alloc_instance},
	{ .compatible = "usbb95,772b", .data = &pwrseq_generic_alloc_instance},
	{ /* sentinel */ }
};
